...
class WhatsappBot:
    ...
    def _newsletter_flow(self, intent: str, query: str):
    ...
    def _ask_for_email_flow(self, intent: str, query: str):
        """Return next action, answer dictionary and retrieved email."""
        email = None
        next_action = "continue"
    ...
    def _ask_for_card_flow(self, intent: str, query: str):
        """Return next action, answer dictionary and retrieved email."""
        email = None
        next_action = "hangup"
        answer = {
    ...
    def message(self, query: str, motive: str):
